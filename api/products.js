...
// design used: scripts/push-products.mjs writes "products:catalog" (metadata) plus
// one "products:quarter:<period>" record per quarter, so a request only ever needs
// two reads: the catalog, and whichever single quarter was asked for via
// ?quarter= (defaulting to the latest).
